...
(* OASIS_START *)
(* DO NOT EDIT (digest: 3af0c2ea1e98d7c33da6d500c9f6a3f3) *)
(*
...
let setup_t =
  {
               ...
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_findlib_name = Some "irmin-indexeddb";
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends = [InternalLibrary "irmin-indexeddb"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
                           {
     ...
     oasis_digest = Some "M\234\006\212\028\144\212\169\152S-\223\1599\142;";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
